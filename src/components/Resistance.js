        ...
        <div className='resistance'>
            ...
            <div className="d-flex flex-column align-items-center">
                ...
                <form className='resistance-form d-flex flex-column' onSubmit={handleResistanceSubmit}>
                    ...
                    <input type="number" name="weight" id="weight" placeholder="0" min={0}
                        value={resistanceForm.weight} onChange={handleResistanceChange} />
                    <label>Sets:</label>
                    <input type="number" name="sets" id="sets" placeholder="0" min={0}
                        value={resistanceForm.sets} onChange={handleResistanceChange} />
                    <label>Reps:</label>
                    <input type="number" name="reps" id="reps" placeholder="0" min={0}
